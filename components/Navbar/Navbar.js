            ...
            <div className="bg-[#171717]">
                <div className="px-4 py-5 mx-auto  sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                    <div className="relative flex items-center justify-between">
                        <div>
                            <Link href='/'><Image src='/image 2.png' width={158} height={50} alt=''></Image></Link>
                        </div>
                            ...
                            <li>
                                <div className="loginSignup">
                                    <div className="mt-[5px] ml-[25px]">
                                        ...
                                        <Link href='/register' className="text-[16px] text-[#FFFFFF]" >Sign up</Link>
                                    </div>
                                </div>
                            </li>
                        </ul>
                        <div className="lg:hidden">
                            ...
                            {isMenuOpen && (
                                <div className="absolute top-0 left-0 w-full">
                                    <div className="p-5 bg-[#171717] border rounded shadow-sm">
                                        ...
                                        <nav>
                                            <ul className="space-y-4">
                                                ...
                                                <li>
                                                    <div className="loginSignup">
                                                        <div className="mt-[5px] flex ml-[10px]">
